...
how_far_remove = 280
rs = (20,15)
log_len = 25 #Taking between 25 and 50

motion_req = 270 # Taking data within the range of 260 - 300, as it is the most stable (determine when there is a collision).
